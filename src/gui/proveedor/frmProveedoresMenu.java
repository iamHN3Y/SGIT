...
public class frmProveedoresMenu extends javax.swing.JFrame {
    ...
    public frmProveedoresMenu(Usuario u) {
        initComponents();
        this.u = u;
    ...
    void cargaTabla() {
        SwingUtilities.invokeLater(() -> {
            try {
                jTable1.setModel(new dao.DAO_Proveedor().tablaProveedores());
    ...
    private void jButton6MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseEntered
        jLabel2.setText("Actualizar Provedores");
    ...
    private void jButton7MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseEntered
        jLabel2.setText("Eliminar Proveedores");
